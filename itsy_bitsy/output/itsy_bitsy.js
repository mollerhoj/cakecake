...
(function() {
  ...
  Physics = (function() {
    ...
    Physics.prototype.build_solid_line = function(x1, y1, x2, y2) {
      ...
      this.fix_def.shape.SetAsEdge(new b2Vec2(x1 / AppData.pixel_per_meter, y1 / AppData.pixel_per_meter), new b2Vec2(x2 / AppData.pixel_per_meter, y2 / AppData.pixel_per_meter));
      return this.solid.CreateFixture(this.fix_def);
    };

    Physics.prototype.build_solid_box = function(x, y, width, height, angle) {
      this.fix_def.shape = new b2PolygonShape;
      this.fix_def.shape.SetAsOrientedBox(width / AppData.pixel_per_meter / 2, height / AppData.pixel_per_meter / 2, new b2Vec2(x / AppData.pixel_per_meter, y / AppData.pixel_per_meter), -angle / 180 * Math.PI);
      return this.solid.CreateFixture(this.fix_def);
    };

    Physics.prototype.build_solid_circle = function(x, y, radius) {
      this.fix_def.shape = new b2CircleShape;
      this.fix_def.shape.SetRadius(radius / AppData.pixel_per_meter);
      console.log(this.fix_def.shape);
      this.fix_def.shape.m_p = new b2Vec2(x / AppData.pixel_per_meter, y / AppData.pixel_per_meter);
      return this.solid.CreateFixture(this.fix_def);
    };

...
(function() {
  ...
  Physics = (function() {
    ...
    Physics.prototype.build_solid_box = function(x, y, width, height, angle) {
      this.fix_def.shape = new b2PolygonShape;
      this.fix_def.shape.SetAsOrientedBox(width / this.PTM / 2, height / this.PTM / 2, new b2Vec2(x / this.PTM, y / this.PTM), -angle / 180 * Math.PI);
      return this.solid.CreateFixture(this.fix_def);
    };

    Physics.prototype.build_solid_circle = function(x, y, radius) {
      this.fix_def.shape = new b2CircleShape;
      this.fix_def.shape.SetRadius(radius / this.PTM);
    ...
    Physics.prototype.build_dynamic = function(x, y, width, height, radius, physics) {
      ...
      if (physics.shape === 'circle') {
        ...
        shape.SetRadius(radius / this.PTM);
      } else {
        shape = new b2PolygonShape();
        shape.SetAsBox(width / this.PTM / 2, height / this.PTM / 2);
      }
      fd = new b2FixtureDef();
      fd.shape = shape;

...
(function() {
  var AppData, Art, Collision, Entity, Game, Hero, ImageLoader, Keyboard, Level, Level2, Level3, Skull, Sprite, Text, World,
  ...
  Game = (function() {
    ...
    Game.setup_keyboard = function() {
      ...
      document.body.onmousemove = function() {
        console.log('mm');
        return Keyboard.mouse_move;
      };
      document.body.onmousedown = function() {
        console.log('md');
        return Keyboard.mouse_down;
      };
      document.body.onmouseup = function() {
        console.log('mu');
        return Keyboard.mouse_up;
      };
      return document.body.oncontextmenu = function() {
        return false;
      };
    };

...
(function() {
  var AppData, Apple, Art, Collision, Entity, Game, GameController, ImageLoader, Keyboard, Level, Level2, Snake, SnakeBody, SnakeBodyShadow, Sprite, Text, World,
  ...
  Apple = (function(_super) {
    ...
    Apple.prototype.die = function() {
      ...
      if (side1 === 0) {
        this.x = Math.random() * AppData.width;
        this.y = side2;
      } else {
        this.x = side2;
        this.y = Math.random() * AppData.height;
      }
  ...
  GameController = (function(_super) {
    ...
    GameController.prototype.life_sprites = [];

    GameController.prototype.init = function() {
      var i, _i;
      for (i = _i = 0; _i <= 10; i = _i += 1) {
        this.life_sprites[i] = new Sprite('Heart');
        this.life_sprites[i].y = 240 - 16;
      }
      this.text = new Text('10', 10, 10);
      this.world.spawn('Snake', 100, 100);
      return this.world.spawn('Apple', 200, 200);
    };
    ...
    GameController.prototype.draw = function() {
      ...
      this.text.draw();
      _results = [];
      for (i = _i = 0, _ref = GameController.lives; _i <= _ref; i = _i += 1) {
        _results.push(this.life_sprites[i].x = 16 + 16 * i);
      }
      return _results;
    };
  ...
  Snake = (function(_super) {
    ...
    Snake.prototype.hits_self = false;
    ...
    Snake.prototype.step = function() {
      ...
      if (this.hits('SnakeBody').some(function(x) {
        return x.solid;
      })) {
  ...
  SnakeBody = (function(_super) {
    ...
    SnakeBody.prototype.step = function() {
      ...
      if (this.time > 10 + 4 * GameController.score) {
        return this.destroy();
      }
    };

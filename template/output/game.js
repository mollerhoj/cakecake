...
(function() {
  ...
  World = (function() {
    ...
    World.prototype.change_level = function(name) {
      this.destroy_all();
      return this.load_level(name);
    };
  ...
  GameController = (function(_super) {
    ...
    GameController.prototype.step = function() {
      if (Keyboard.press('ESCAPE')) {
        return this.world.change_level('Menu');
      }
    };
  ...
  Menu_2D = (function(_super) {
    ...
    Menu_2D.prototype.init = function() {
      var i, t, _i, _j, _ref, _ref1, _results;
      this.x = 160;
      this.y = 300;
      this.marker = new Sprite('Marker');
      this.texts[0] = new Text('Back');
      this.texts[0].x = this.x - this.button_x_space;
      this.texts[0].y = this.y;
      for (i = _i = 1, _ref = this.button_n; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
        this.texts[i] = new Text("Level " + i);
      }
      _results = [];
      for (i = _j = 1, _ref1 = this.button_n; 1 <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = 1 <= _ref1 ? ++_j : --_j) {
        ...
        if (t) {
          t.align = 'center';
          t.font = 'Arial';
          t.y = this.y + Math.floor((i - 1) / this.cols) * this.button_y_space;
          _results.push(t.x = this.x + ((i - 1) % this.cols) * this.button_x_space);
        } else {
          _results.push(void 0);
        }
      }
  ...
  Pendulum = (function(_super) {
    ...
    Pendulum.prototype.w = 8;

    Pendulum.prototype.h = 8;
    ...
    Pendulum.prototype.step = function() {
      ...
      Pendulum.__super__.step.call(this);
      if (this.bullet) {
